...
export default function About() {
  return (
    <section id="about" className="relative px-4 py-20 sm:px-6 md:py-28 overflow-hidden">
      {/* Ambient glow */}
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <div className="absolute -inset-4 rounded-[32px] opacity-50 blur-2xl">
            ...
            <div className="relative rounded-[28px] overflow-hidden border border-white/10 shadow-[0_0_0_1px_rgba(255,255,255,0.05),0_40px_120px_rgba(0,0,0,0.5)]">
              ...
              <div className="absolute bottom-6 left-6 right-6 z-30">
                <div className="glass-strong rounded-2xl p-5 border border-white/10 backdrop-blur-xl">
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      <div className="h-12 w-12 rounded-full bg-gradient-to-br from-primary to-purple-glow flex items-center justify-center text-white font-bold text-lg shadow-[0_0_20px_rgba(99,102,241,0.5)]">
                        W
                      </div>
                      <div className="absolute -bottom-1 -right-1 h-4 w-4 rounded-full bg-green-500 border-2 border-[#0B0F1F] shadow-[0_0_10px_rgba(34,197,94,0.6)]" />
                    </div>
                    <div>
                      <h3 className="text-white font-bold text-lg">Wahyudi</h3>
                      <p className="text-primary text-sm font-semibold">Founder & Lead Developer</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="glass-strong rounded-2xl p-4 border border-white/10 backdrop-blur-xl shadow-2xl">
                <div className="flex items-center gap-3">
            ...
            >
              <div className="glass-strong rounded-2xl p-4 border border-white/10 backdrop-blur-xl shadow-2xl">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-cyan/20 to-cyan/5 border border-cyan/20 flex items-center justify-center">
                    <Icons.Globe className="h-5 w-5 text-cyan" />
                  </div>
                  <div>
                    <p className="text-xs text-muted/70">Projects</p>
                    <p className="text-white font-bold text-lg">50+ Done</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            {/* Section label */}
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-gradient-to-r from-primary/10 to-purple-glow/10 px-4 py-2 text-xs font-semibold text-primary mb-6">
            ...
            {/* Subtitle */}
            <p className="text-xl text-muted/90 font-light mb-8 leading-relaxed">
              Founder of{" "}
            ...
            {/* Description */}
            <div className="space-y-4 text-muted/80 leading-relaxed mb-8">
              <p>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {[
                ...
                <div key={stat.label} className="group">
                  <div className="text-2xl md:text-3xl font-bold bg-gradient-to-br from-white to-white/60 bg-clip-text text-transparent group-hover:from-primary group-hover:to-cyan transition-all duration-500">
                    {stat.value}
                  </div>
            ...
            {/* Expertise Tags */}
            <div className="mb-8">
              <p className="text-xs font-semibold text-muted/60 uppercase tracking-wider mb-3">Expertise</p>
              <div className="flex flex-wrap gap-2">
                {["AI & Machine Learning", "Full-Stack Development", "Mobile Apps", "Cloud Architecture", "Automation", "API Integration"].map((skill) => (
                  <span
                    key={skill}
                    className="rounded-lg bg-gradient-to-r from-white/[0.04] to-white/[0.02] px-3 py-1.5 text-xs font-medium text-muted/70 border border-white/5 hover:border-primary/30 hover:text-white transition-all duration-300 cursor-default"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="group relative inline-flex items-center justify-center gap-2 px-7 py-3.5 text-base font-semibold rounded-xl overflow-hidden"
              >
              ...
              <a
                href="#works"
                className="btn-secondary inline-flex items-center justify-center gap-2 px-7 py-3.5 text-base font-semibold rounded-xl"
              >
            ...
            <div className="mt-8 flex items-center gap-4">
              <p className="text-xs text-muted/60">Follow me:</p>
              <div className="flex gap-3">
                {[
                  ...
                  <a
                    key={social.label}
                    href={social.href}
                    className="group relative h-10 w-10 rounded-xl bg-white/[0.02] border border-white/5 flex items-center justify-center hover:border-primary/30 hover:bg-primary/10 transition-all duration-300"
                    aria-label={social.label}
                  >
                    <social.icon className="h-4.5 w-4.5 text-muted/60 group-hover:text-white transition-colors" />
                    <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-primary/20 to-transparent opacity-0 group-hover:opacity-100 blur-md transition-opacity" />
                  </a>
                ))}
              </div>
            </div>
